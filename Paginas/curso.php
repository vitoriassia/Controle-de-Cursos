...
function Cadastrado()
{
    swal(
      'Ja Cadastrado!',
      'Você ja é cadastrado nessa materia!',
      'warning'
    )
}
</script>
...
<div id="services" class="container-fluid text-center">
  ...
  while ($linha = mysqli_fetch_array($resultado)) {
   ...
   echo "</td>";
   echo "<td width=50>";
   echo "<form method=post action=Aprendizadofazer.php name=acao>";
...
if (mysqli_fetch_array($resultadoCadastro) == null) {
    echo "<button class='btn btn-primary btn-lg btn-block' type=submit name=acao value=Inscrever>Inscrever</button>";
    echo "</form>";
}else{
    echo "</form>";
